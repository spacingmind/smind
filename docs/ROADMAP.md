...
- [ ] Extract `internal/claudecode` into its own Go module/repo — no official Go SDK for Claude Code exists yet; deferred until after this integration work lands to avoid restructuring under an in-flight consumer.
