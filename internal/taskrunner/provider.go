...
// internal/claudecode (Claude Code's native headless protocol) and exposing
// one unified streaming interface to callers regardless of which backend a
// given task's agent actually speaks.
package taskrunner
...
const (
	...
	// CLI protocol (internal/claudecode).
