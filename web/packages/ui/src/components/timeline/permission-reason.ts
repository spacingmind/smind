 ...
 * `timeout` as the one worth a second look (nobody decided in time). A
 * reason this build has never heard of (or none at all, from an older
 * server payload) has no entry here -- callers treat a missing lookup as
