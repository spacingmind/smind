      ...
      return (
        <li data-testid="timeline-thinking" data-item-kind="thinking">
          ...
          <details className="rounded-xl border border-dashed">
            ...
            <div
              data-chat-find-text="true"
              className="border-t border-dashed px-2.5 py-1.5 text-ui-sm whitespace-pre-wrap text-foreground-muted"
            >
              {item.text}
            </div>
          </details>
        ...
        <li data-testid="timeline-unknown" data-item-kind="unknown">
          {item.rawKind ? (
            <details className="rounded-xl border border-dashed">
              ...
              <pre className="overflow-x-auto border-t border-dashed px-2.5 py-1.5 text-ui-sm whitespace-pre-wrap text-foreground-muted">
...
function PermissionRow({ item }: { item: TimelinePermissionItem }) {
  ...
  return (
    <p className="flex items-center gap-1.5 px-0.5 text-ui-sm text-foreground-muted">
