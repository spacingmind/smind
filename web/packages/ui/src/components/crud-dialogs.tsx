...
function FormError({ message }: { message: string | null }) {
  ...
  return <p className="text-ui-sm text-destructive">{message}</p>;
}
        ...
        {open && (
          ...
          >
            <div className="grid gap-2">
              <label htmlFor="workspace-path" className="text-ui-sm font-medium">
                Path
              </label>
            ...
            <div className="grid gap-2">
              <label htmlFor="workspace-title" className="text-ui-sm font-medium">
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      {open && (
        ...
        >
          <div className="grid gap-2">
            <label htmlFor="space-title" className="text-ui-sm font-medium">
              Title
            </label>
            <Input
              id="space-title"
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      {open && (
        ...
        >
          <div className="grid gap-2">
            <label htmlFor="task-title" className="text-ui-sm font-medium">
              Title
            </label>
            <Input
              id="task-title"
          ...
          {fixedSpaceId === null && (
            <div className="grid gap-2">
              <label htmlFor="task-space" className="text-ui-sm font-medium">
