  ...
  return (
    <div className="flex flex-col gap-6" data-testid="settings-section-notifications">
      <section className="flex flex-col gap-2">
        <h3 className="text-ui-sm font-medium text-foreground">Notifications</h3>
        <div className="flex items-center justify-between gap-4">
          <p className="max-w-sm text-ui-sm text-muted-foreground">{PERMISSION_DESCRIPTION[permission]}</p>
          <Button
            variant="outline"
            size="sm"
      ...
      <section className="flex items-center justify-between gap-4">
        <div className="flex flex-col gap-0.5">
          <h3 className="text-ui-sm font-medium text-foreground">Play a sound</h3>
      ...
      <section className="flex flex-col gap-2">
        <div className="flex items-center justify-between gap-4">
          <div className="flex flex-col gap-0.5">
            <h3 className="text-ui-sm font-medium text-foreground">Test notification</h3>
            <p className="max-w-sm text-ui-sm text-muted-foreground">
              {permission === "granted"
