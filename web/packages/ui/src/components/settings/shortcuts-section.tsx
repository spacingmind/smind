  ...
  return (
    <div className="flex flex-col gap-4" data-testid="settings-section-shortcuts">
      <input
        ...
        className="h-8 w-full max-w-sm rounded-lg border border-input bg-transparent px-2 text-sm outline-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50"
      />
